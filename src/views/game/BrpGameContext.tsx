...
function createBrpGameContext<TContextType extends {} | null>() {
    ...
    function useBrpGameContext() {
        ...
        if (c === undefined) { throw new Error('useBrpGameContext must be inside a Provider with a value'); }
        return c;
    }
    return [useBrpGameContext, context.Provider] as const;
}

export const [useBrpGameContext, BrpContextProvider] = createBrpGameContext<BrpGameConfig>();
